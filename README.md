...
Aplicación construida con Streamlit que combina datos macroeconómicos de múltiples fuentes (FRED, EODHD) con noticias en tiempo real (NewsAPI) y un analista conversacional impulsado por LangChain y modelos servidos por Ollama. Permite al usuario explorar indicadores macro clave, generar visualizaciones rápidas, analizar sentimiento de noticias y obtener un juicio cualitativo sobre el posible impacto en el índice S&P 500.
